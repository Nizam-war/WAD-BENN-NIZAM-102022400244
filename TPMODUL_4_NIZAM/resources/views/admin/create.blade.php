            ...
            <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data" class="p-8 sm:p-10">
                ...
                <div class="mb-8">
                    ...
                    <input type="text" name="name" id="name" placeholder="Masukkan nama produk"
                        value="{{ old('name') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition @error('name') border-red-500 @enderror"
                        required>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="description" id="description" rows="6"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 resize-none transition @error('description') border-red-500 @enderror"
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" name="price" id="price" placeholder="0"
                            value="{{ old('price') }}"
                            class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition @error('price') border-red-500 @enderror"
                            required>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-8 hover:border-blue-500 transition cursor-pointer group"
                    ...
                    <div id="imagePreview" class="hidden">
                        <div class="bg-slate-100 rounded-lg p-4 mt-4">
                            ...
                            <img id="preview" class="w-full max-w-xs rounded-lg shadow-md" />
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-8 border-t border-gray-200">
                    <a href="{{ route('admin.index') }}"
                       class="flex-1 inline-flex items-center justify-center bg-gray-200 hover:bg-gray-300 text-gray-900 font-semibold py-3 rounded-lg transition">
                        Batal
                    </a>

                    <button type="submit"
                            class="flex-1 inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg transition">
                        Simpan Produk
                    </button>
                </div>
